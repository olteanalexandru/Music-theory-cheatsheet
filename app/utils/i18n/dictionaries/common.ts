...
export const ro: CommonDict = {
    ...
    footer: {
        newsletterTitle: 'Primește sfaturi de exersare pe email',
    ...
    toolNav: {
        overview: 'Prezentare',
        fretboard: 'Tastatură chitară',
        circleOfFifths: 'Cercul Cvintelor',
        staff: 'Portativ',
        clefTrainer: 'Antrenor Chei',
        rhythm: 'Ritm',
    ...
    audioSettings: {
        ...
        listening: 'Se ascultă bătăile și notele.',
